    ...
    <div className="page">
      ...
      <div className="metric-grid">
        ...
        <Metric
          label="待复核"
          value={
            jobsQuery.data?.filter(j => j.status === 'NEEDS_REVIEW').length ?? '—'
          }
          hint="需要人工确认"
          icon="✓"
          tone="amber"
                ...
                <tbody>
                  {jobs.map(job => (
                    <tr key={job.id}>
                      ...
                      <td className="muted">
                        {job.evidenceCount ? `${job.evidenceCount} 条` : '—'}
                      </td>
                      <td className="row-action-cell">
                        ...
                        {menuJob === job.id && (
                          <div className="row-popover">
                            ...
                            {['RUNNING', 'QUEUED', 'NEEDS_REVIEW'].includes(
                              job.status,
                            ) && (
                              <button
